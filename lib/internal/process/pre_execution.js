...
function setupHttpProxy() {
  if ((process.env.NODE_USE_ENV_PROXY || getOptionValue('--use-env-proxy')) &&
    ...
    // TODO(joyeecheung): This is currently guarded with NODE_USE_ENV_PROXY or --use-env-proxy. Investigate whether
